...
move /y app\assets\emulator\gbcore.js app\assets\emulator\gbcore-glue.bin >nul

echo.
echo Built app\assets\emulator\gbcore-glue.bin and app\assets\emulator\gbcore.wasm
